            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="box allusers">
                    <div class="box-header">
                        <h3 class="box-title">Forex Bureaus</h3>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <?php
                            if ($forexusers > 0) {
                                $query_forex_bureaus = $db->query('SELECT * FROM forexbureaus ORDER BY FxBureauId ASC');

                                foreach ($query_forex_bureaus as $fx_bureau) {
                                    ?>
                                    <tr>
                                        <td class="uname"><?php echo $fx_bureau["FxBureauName"]; ?></td>
                                        <td class="uemail"><?php echo $fx_bureau["FxBureauSupportEmail"]; ?></td>
                                        <td class="utelephone"><?php echo $fx_bureau["FxBureauSupportTel"]; ?></td>
                                        <td class="uphyadd"><?php echo $fx_bureau["FxBureauPhysicalAddress"]; ?></td>
                                        <td class="udate"><?php echo $fx_bureau["FxBureauTime"] ?></td>
                                        <td>
                                            <ul class="tools" id="<?php echo $fx_bureau["FxBureauId"] ?>">
                                                <i class="fa fa-trash-o" title="Delete <?php echo $fx_bureau["FxBureauName"]; ?>"></i>
                                                <i class="fa  fa-edit" title="Edit <?php echo $fx_bureau["FxBureauName"]; ?>"></i>
                                            </ul>
                                        </td>
                                    </tr>
                                    <?php
